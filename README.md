...
**[→ Watch the compartment-specificity finding](https://claude.ai/code/artifact/41377e0e-d918-438d-a909-009f0dbebc45)** — real 3D positions again, this time colored by dopamine-cluster identity: watch the blue (punishment-associated) MBONs dim while the teal (reward-associated) ones don't move.
